 ...
 */
export declare const getStatus: (params: GetStatusRequestExtended, options?: RequestOptions) => Promise<StatusResponse>;
/**
 ...
 */
export declare const getToken: (chain: ChainKey | ChainId, token: string, options?: RequestOptions) => Promise<TokenExtended>;
/**
