...
export type TypedDataPrimaryType = 'Permit' | 'PermitTransferFrom' | 'PermitBatchTransferFrom' | 'PermitWitnessTransferFrom' | 'PermitBatchWitnessTransferFrom' | 'Order' | 'HyperliquidTransaction:Withdraw';
/**
 * EIP-712 Typed Data
