import { type Account, type BtcRpcRequestFn, type ClientConfig as base_ClientConfig, type Transport as base_Transport, type Chain, type Client, type Compute, type ExactPartial, type LooseOmit, type OneOf } from '@bigmi/core';
import { type Mutate, type StoreApi } from 'zustand/vanilla';
import type { ConnectorEventMap, CreateConnectorFn } from '../types/connector.js';
...
export type Transport<type extends string = string, rpcAttributes = Record<string, any>, btcRequestFn extends BtcRpcRequestFn = BtcRpcRequestFn> = (params: Parameters<base_Transport<type, rpcAttributes, btcRequestFn>>[0] & {
    connectors?: StoreApi<Connector[]> | undefined;
}) => ReturnType<base_Transport<type, rpcAttributes, btcRequestFn>>;
type ClientConfig = LooseOmit<base_ClientConfig, 'account' | 'chain' | 'key' | 'name' | 'transport' | 'type'>;
export {};
