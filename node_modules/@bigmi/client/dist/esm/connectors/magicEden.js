import { base64ToHex, hexToBase64, MethodNotSupportedRpcError, ProviderNotFoundError, UserRejectedRequestError, } from '@bigmi/core';
import { createConnector } from '../factories/createConnector.js';
import { createUnsecuredToken } from '../utils/createUnsecuredToken.js';
magicEden.type = 'UTXO';
export function magicEden(parameters = {}) {
    ...
    return createConnector((config) => ({
        ...
        async onAccountsChanged(accounts) {
            if (accounts.length === 0) {
                ...
                const filteredAccounts = accounts.filter((account) => account.purpose === 'payment');
...
//# sourceMappingURL=magicEden.js.map