...
const EpicGamesIcon = Iconic.createIconic({
    alt: 'epicGames',
    iconName: 'epicgames',
    sourcePath: 'icons/social/epicgames.svg',
});
const EpicGamesDarkIcon = Iconic.createIconic({
    alt: 'epicGames-dark',
...
const KrakenIcon = Iconic.createIconic({
    alt: 'kraken',
    iconName: 'kraken',
    sourcePath: 'icons/social/kraken.svg',
});
const KrakenDarkIcon = Iconic.createIconic({
    alt: 'kraken-dark',
...
exports.EpicGamesDarkIcon = EpicGamesDarkIcon;
...
exports.KrakenDarkIcon = KrakenDarkIcon;
exports.KrakenIcon = KrakenIcon;
