...
const ByBitIcon = Iconic.createIconic({
    alt: 'ByBit Wallet',
    iconName: 'bybit',
...
const SlushIcon = Iconic.createIconic({
...
const SuietIcon = Iconic.createIconic({
    alt: 'Suiet Wallet',
    iconName: 'suiet',
...
const DynamicWaasIcon = Iconic.createIconic({
    alt: 'Dynamic Waas',
...
exports.DynamicWaasIcon = DynamicWaasIcon;
